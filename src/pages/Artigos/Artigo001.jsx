...
const Artigo001 = () => {
  return (
    <div>
        <div className="blog_area single-post-area section_padding">
            <div className="container">
                ...
                <div className="col-lg-12 posts-list">
                    ...
                    <div className="blog_details">
                        ...
                        <li>
                            <a href="#"
                            ><i className="far fa-user"></i> Música, Show, Cultura</a>
                            
                        </li>
                        <li>
                            <a href="#"><i className="far fa-comments"></i> 03 Comentários</a>
                        </li>
                        </ul>
                        <p className="excert">
                    ...
                    <div className="d-sm-flex justify-content-between text-center">
                        ...
                        <span className="align-middle"><i className="far fa-heart"></i></span>
