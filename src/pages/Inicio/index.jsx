      ...
      <Box component="main">
          ...
          <Container sx={{ py: 5 }} maxWidth={"lg"}>
            <Stack direction={{ sm: "column-reverse", md: "row" }}>
              <Box width={{ sm: "100%", md: "50%" }}>
                ...
                <Box sx={{ display: "flex", gap: "20px", my: 5 }}>
                  {user === "admin" && (
                    <NavLink to="/dashboard" className="btn_1 h-25">
                      Dashboard ADM
                    </NavLink>
                  )}
                  {user !== "admin" && auth && (
                    <NavLink to="/blog" className="btn_1 h-25">
                      Artigos
                    </NavLink>
                  )}
                  {!auth && (
                    <NavLink to="/registrar" className="btn_1 h-25">
                      Crie sua conta
                    </NavLink>
                  )}
                  ...
                  {auth ? (
                    <Button
                      ...
                      variant="outlined"
                      className="btn_2 h-25"
                      onClick={logout}
                    >
                      Deslogar
                    </Button>
                  ) : (
                    <NavLink to="/login" className="btn_2 h-25">
                      Login
                    </NavLink>
                  )}
                </Box>
            ...
            <div className="row">
              <div className="col-sm-6 col-xl-3 align-self-center">
                <div className="single_feature_text">
                  ...
                  <p>
                    Alfabetizar jovens e adultos não é uma tarefa simples, mas
                    ela precisa ser feita. A educação, como prevê a nossa
              ...
              <div className="col-sm-6 col-xl-3">
                <div className="single_feature">
                  <div className="single_feature_part">
                    ...
                    <p>
                      A situação do analfabetismo não só nas zonas rurais, mas
                      em todo Brasil, só será erradicada com a ajuda de todos
                      para um bem maior e para um Brasil que dê importância para
                      educação.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-md-5 col-lg-5">
                <div className="learning_member_text">
                  ...
                  <p>
                    ...
                    nosso nascimento, é a base de todas pessoas e de onde
                    podemos realizar nossos objetivos de vida.
                  </p>
                  <ul>
                    <li>
            ...
            <div className="row align-items-sm-center align-items-xl-stretch">
              <div className="col-md-6 col-lg-6">
                <div className="learning_member_text">
                  ...
                  <p>
                    Uma das principais relações entre tecnologia e cultura na
                    vida das pessoas é vista no desenvolvimento das relações
                    interpessoais. Isso porque, antes das inovações
                    tecnológicas, as relações – tanto de amizade quanto amorosas
                    – eram formadas em um espaço mais restrito e com poucas
        ...
        >
          {participantes.map((item) => (
            <Box
              key={item.id}
              sx={{ display: "flex", width: 500, m: 2, gap: 2 }}
            >
              <Box
                component={Paper}
                elevation={10}
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <p align="justify">
                        ...
                        Gil/João Donato) que ganhou literalmente o mundo a
                        partir de diferentes intérpretes além do próprio Donato.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="single-home-blog">
                  <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <p align="justify">
                        Enxergamos que apoiar projetos socioculturais que atuem
                        no campo, zonas rurais e florestas é uma ótima forma de
              ...
              <div className="col-sm-6 col-lg-4 col-xl-4">
                <div className="single-home-blog">
                  <div className="card">
                    <Box
                      sx={{
                        backgroundImage: `url(${meninoViolao})`,
                        backgroundPosition: "left",
                        backgroundRepeat: "no-repeat",
                        backgroundSize: "cover",
                        height: 250,
